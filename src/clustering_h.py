...
if __name__ == '__main__':
    ...
    # data = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/auto-mpg.csv'), index_col=False)data = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/auto-mpg.csv'), index_col=False)
    X = np.array([[5,3],
    [10,15],
    [15,12],
    [24,10],
